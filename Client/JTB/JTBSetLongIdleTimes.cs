namespace Client.JTB
{
    ...
    public partial class JTBSetLongIdleTimes : CarForm
    {
        private TrafficSimpleCmd m_SimpleCmd = new TrafficSimpleCmd();

        public JTBSetLongIdleTimes(CmdParam.OrderCode OrderCode)
        {
 ...
 private bool getParam()
        {
            ...
            this.m_SimpleCmd.OverRunIdleSpeedTimes = this.numTimes.Value.ToString();
            return true;
        }
