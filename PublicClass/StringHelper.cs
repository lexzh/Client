namespace PublicClass
{
    ...
    public class StringHelper
    {
        ...
        {
            if ((nCode >= 0x641) && (nCode < 0x665))
            {
                return "A";
            }
            if ((nCode >= 0x665) && (nCode < 0x729))
            {
                return "B";
            }
            if ((nCode >= 0x729) && (nCode < 0x81e))
            {
                return "C";
            }
            if ((nCode >= 0x81e) && (nCode < 0x8e2))
            {
                return "D";
            }
            if ((nCode >= 0x8e2) && (nCode < 0x8fe))
            {
                return "E";
            }
            if ((nCode >= 0x8fe) && (nCode < 0x981))
            {
                return "F";
            }
            if ((nCode >= 0x981) && (nCode < 0xa22))
            {
                return "G";
            }
            if ((nCode >= 0xa22) && (nCode < 0xae3))
            {
                return "H";
            }
            if ((nCode >= 0xae3) && (nCode < 0xc22))
            {
                return "J";
            }
            if ((nCode >= 0xc22) && (nCode < 0xc8c))
            {
                return "K";
            }
            if ((nCode >= 0xc8c) && (nCode < 0xd90))
            {
                return "L";
            }
            if ((nCode >= 0xd90) && (nCode < 0xe33))
            {
                return "M";
            }
            if ((nCode >= 0xe33) && (nCode < 0xe8a))
            {
                return "N";
            }
            if ((nCode >= 0xe8a) && (nCode < 0xe92))
            {
                return "O";
            }
            if ((nCode >= 0xe92) && (nCode < 0xf12))
            {
                return "P";
            }
            if ((nCode >= 0xf12) && (nCode < 0xfbb))
            {
                return "Q";
            }
            if ((nCode >= 0xfbb) && (nCode < 0xff6))
            {
                return "R";
            }
            if ((nCode >= 0xff6) && (nCode < 0x1126))
            {
                return "S";
            }
            if ((nCode >= 0x1126) && (nCode < 0x11ce))
            {
                return "T";
            }
            if ((nCode >= 0x11ce) && (nCode < 0x124c))
            {
                return "W";
            }
            if ((nCode >= 0x124c) && (nCode < 0x133d))
            {
                return "X";
            }
            if ((nCode >= 0x133d) && (nCode < 0x1481))
            {
                return "Y";
            }
            if ((nCode >= 0x1481) && (nCode < 0x15d6))
            {
                return "Z";
            }
            return "";
        ...
        public static string GetChineseSpell2(string chrStr)
        {
            ...
            for (int i = 0; i < chrStr.Length; i++)
            {
                try
                {
                    byte[] bytes = encoding.GetBytes(chrStr.Substring(i, 1));
                    string str2 = Convert.ToString((int) (bytes[0] - 160), 0x10);
                    if (bytes.Length < 2)
                    {
                        str = str + chrStr.Substring(i, 1);
                    }
                    else
                    {
                        string str3 = Convert.ToString((int) (bytes[1] - 160), 0x10);
                        int nCode = (Convert.ToUInt16(str2, 0x10) * 100) + Convert.ToUInt16(str3, 0x10);
                        str = str + FirstLetter(nCode);
                    }
                }
                catch
                {
